...
\item \emph{prezzo medio effettivo nel saldo} precedente alla vendita \Eur{50,00};
\item \emph{prezzo medio di carico nel saldo} precedente alla vendita: \Eur{50,15};
\item \emph{costo medio per quota nel saldo} precedente alla vendita: \Eur{0,15};
\end{itemize}

...
Si cerca  di vendere le quote  in modo che  la media ponderata dei  \emph{prezzi medi
   netti  di vendita}  sia  maggiore del  \emph{prezzo medio  di  carico nel  saldo}.
Riprendendo le operazioni dell'esempio precedente:
\begin{enumerate}
\item acquisto di \num{20} quote al \emph{prezzo  medio di carico di acquisto} pari a
  \Eur{22,00};
\item acquisto di \num{30} quote al \emph{prezzo  medio di carico di acquisto} pari a
...
\item vendita  di \num{40}  quote a un  \emph{prezzo medio netto  di vendita}  pari a
  \Eur{48,00};
\end{enumerate}
il \emph{prezzo medio di carico nel saldo} risulta:
\begin{equation*}
  \frac{20 \times{} \num{22,00} + 30 \times{} \num{33,00} + 40 \times{} \num{44,00}}
  {20 + 30 + 40} = \Eur{35,44}
\end{equation*}
...
\begin{equation*}
  ...
  {20 + 30 + 40} = \Eur{40,22}
\end{equation*}
quindi il rendimento totale percentuale risulta:
\begin{align*}
...
Come altro esempio, si supponga di eseguire le operazioni:
\begin{enumerate}
\item acquisto di \num{20} quote al \emph{prezzo  medio di carico di acquisto} pari a
  \Eur{22,00};
\item acquisto di \num{30} quote al \emph{prezzo  medio di carico di acquisto} pari a

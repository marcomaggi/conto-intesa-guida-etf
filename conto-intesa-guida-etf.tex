...
quote;  \emph{prezzo medio  di  carico} di  \Eur{0}; \emph{NAV  del  prezzo medio  di
   carico} di \Eur{0}.  L'aggiornamento del saldo avviene come segue.
\begin{enumerate}
...
\item Dopo il primo acquisto:
  ...
  \item il \emph{NAV del prezzo medio carico nel saldo} è uguale al \emph{prezzo medio
       eseguito} del primo acquisto: \Eur{110,00};
  \item  il  \emph{controvalore totale  nel  saldo}  è uguale  al  \emph{controvalore
       totale} del primo acquisto: \Eur{11029,40}.
  \end{itemize}
...
\item Dopo il secondo acquisto:
  \begin{itemize}
    ...
    \item il \emph{prezzo medio di carico carico  nel saldo} è la media ponderata dei
      ...
      \end{equation*}
    \item il \emph{NAV  del prezzo medio carico  nel saldo} è la  media ponderata dei
      prezzi medi di carico del saldo precedente e del nuovo acquisto:
      \begin{equation*}
        \MediaPonderataDue{100}{110,00}{200}{120,00} = \Eur{116,67}
      \end{equation*}
    \item  il \emph{controvalore  totale nel  saldo} è  la somma  tra i  controvalori
      totali del saldo precedente e del nuovo acquisto:
      \begin{equation*}
        \num{11029,40} + \num{24060,60} = \Eur{35090,00}
      \end{equation*}
  \end{itemize}
...
\Eur{123,64} e il \emph{NAV del prezzo medio di carico nel saldo} di \Eur{123,33}:
\begin{equation*}

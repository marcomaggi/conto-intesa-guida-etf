...
\item  per   la  prima  linea  di   investimento  si  acquisti   quando  il  prezzo  di   mercato  è
  ...
  \item \emph{controvalore dell'operazione}:
    \(\Cacq{1} = \Eur{\unoStratInvLineeAcquistoControvaloreOperazione{}}\);
  \item \emph{costo dell'operazione}:
    \(\Facq{1} = \Eur{\unoStratInvLineeAcquistoCostoOperazione{}}\);
  \item \emph{controvalore totale}:
    \(\Ctotacq{1} = \Eur{\unoStratInvLineeAcquistoControvaloreTotale}\);
  \item \emph{prezzo medio di carico}:
...
\item  per  la  seconda   linea  di  investimento  si  acquisti  quando  il   prezzo  di  mercato  è
  ...
  \item \emph{controvalore dell'operazione}:
    \(\Cacq{2} = \Eur{\dueStratInvLineeAcquistoControvaloreOperazione{}}\);
  \item \emph{costo dell'operazione}:
    \(\Facq{2} = \Eur{\dueStratInvLineeAcquistoCostoOperazione{}}\);
  \item \emph{controvalore totale}:
    \(\Ctotacq{2} = \Eur{\dueStratInvLineeAcquistoControvaloreTotale}\);
  \item \emph{prezzo medio di carico}:
...
\item  per   la  terza  linea  di   investimento  si  acquisti   quando  il  prezzo  di   mercato  è
  ...
  \item \emph{controvalore dell'operazione}:
    \(\Cacq{3} = \Eur{\treStratInvLineeAcquistoControvaloreOperazione{}}\);
  \item \emph{costo dell'operazione}:
    \(\Facq{3} = \Eur{\treStratInvLineeAcquistoCostoOperazione{}}\);
  \item \emph{controvalore totale}:
    \(\Ctotacq{3} = \Eur{\treStratInvLineeAcquistoControvaloreTotale}\);
  \item \emph{prezzo medio di carico}:
...
%page
\subsubsection{Vendita delle quote della prima linea di investimento.}
...
\item con  la quantità  di soldi  addebitata sul  Conto Corrente  per acquistare  le quote,  cioè il
  \emph{controvalore totale di acquisto}, e la quantità di soldi accreditata sul Conto Corrente dopo
  la vendita delle quote, cioè il \emph{controvalore totale di vendita};
\item con il \emph{prezzo medio di carico di acquisto} e il \emph{prezzo medio netto di vendita};
\end{enumerate}
il rendimento percentuale della compravendita risulta:
\begin{align*}
  \eta
  &= \CalcoloRendimentoPercentualeSim{\Ctotven{1}}{\Ctotacq{1}}
    = \CalcoloRendimentoPercentuale{\quattroStratInvLineeVenditaControvaloreTotale}{\unoStratInvLineeAcquistoControvaloreTotale}
  \\
...
%page
\subsubsection{Vendita delle quote della seconda linea di investimento.}
...
\begin{align*}
  \eta
  &= \CalcoloRendimentoPercentualeSim{\Ctotven{2}}{\Ctotacq{2}}
    = \CalcoloRendimentoPercentuale{\cinqueStratInvLineeVenditaControvaloreTotale}{\unoStratInvLineeAcquistoControvaloreTotale}
  \\
  &= \CalcoloRendimentoPercentualeSim{\Pmnv{2}}{\Pmca{2}}
    = \CalcoloRendimentoPercentuale{\cinqueStratInvLineeVenditaPrezzoMedioNettoVendita}{\unoStratInvLineeAcquistoPrezzoMedioCarico}
    = \SI{\cinqueStratInvLineeRendimentoPercentualeLinea}{\percent}
\end{align*}

%page
\subsubsection{Vendita delle quote della terza linea di investimento.}
...
\begin{align*}
  \eta
  &= \CalcoloRendimentoPercentualeSim{\Ctotven{3}}{\Ctotacq{3}}
    = \CalcoloRendimentoPercentuale{\seiStratInvLineeVenditaControvaloreTotale}{\unoStratInvLineeAcquistoControvaloreTotale}
  \\
  &= \CalcoloRendimentoPercentualeSim{\Pmnv{3}}{\Pmca{3}}
    = \CalcoloRendimentoPercentuale{\seiStratInvLineeVenditaPrezzoMedioNettoVendita}{\unoStratInvLineeAcquistoPrezzoMedioCarico}

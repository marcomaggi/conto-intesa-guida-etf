...
l'espressione generale delle  commissioni?  Nominato \(\Plimmev{}\) il  \emph{prezzo medio effettivo
...
\begin{equation*}
  \Fven{} / \Nven{}
  = \left(b / \Nven{}\right) \times{} \Plimmev{} + \left(a / \Nven{}\right)
\end{equation*}
Il \emph{reddito da capitale} risulta:
\begin{equation*}
  \Rcap{}
...
\begin{align*}
  ...
  &= \Plimmev{} - \Fven{} / \Nven{} - \Tredcap{} / \Nven{}
    \\
  &= \Plimmev{}
    - b \times{} \Plimmev{} - a / \Nven{}
    - \num{0,26} \times{} \left(\Plimmev{} - \Pmes{}\right)
\end{align*}
Raccogliendo a fattor comune i coefficienti di \(\Plimmev{}\) e semplificando:
\begin{equation*}
  \left( 1 - \num{0,26} - b \right) \times{} \Plimmev{}
  = \left( \num{0,74} - b \right) \times{} \Plimmev{}
\end{equation*}
quindi:
\begin{align*}
  \Pmnv{}

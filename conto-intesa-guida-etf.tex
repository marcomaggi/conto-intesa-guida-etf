...
\item  per   la  prima  linea  di   investimento  si  acquisti   quando  il  prezzo  di   mercato  è
  ...
  \begin{itemize}
  \item numero quote \num{\unoStratInvLineeAcquistoNumeroQuote{}};
  \item prezzo medio eseguito di acquisto \Eur{\unoStratInvLineeAcquistoPrezzoMedioEffettivo{}};
  \item controvalore dell'operazione \Eur{\unoStratInvLineeAcquistoControvaloreOperazione{}};
  \item costo dell'operazione di acquisto \Eur{\unoStratInvLineeAcquistoCostoOperazione{}};
  \item controvalore totale \Eur{\unoStratInvLineeAcquistoControvaloreTotale};
  \item prezzo medio di carico di acquisto \Eur{\unoStratInvLineeAcquistoPrezzoMedioCarico};
  \end{itemize}
...
\item  per  la  seconda   linea  di  investimento  si  acquisti  quando  il   prezzo  di  mercato  è
  ...
  \begin{itemize}
  \item numero quote \num{\dueStratInvLineeAcquistoNumeroQuote{}};
  \item prezzo medio eseguito di acquisto \Eur{\dueStratInvLineeAcquistoPrezzoMedioEffettivo{}};
  \item controvalore dell'operazione \Eur{\dueStratInvLineeAcquistoControvaloreOperazione{}};
  \item costo dell'operazione di acquisto \Eur{\dueStratInvLineeAcquistoCostoOperazione{}};
  \item controvalore totale \Eur{\dueStratInvLineeAcquistoControvaloreTotale};
  \item prezzo medio di carico di acquisto \Eur{\dueStratInvLineeAcquistoPrezzoMedioCarico};
  \end{itemize}
...
\item  per   la  terza  linea  di   investimento  si  acquisti   quando  il  prezzo  di   mercato  è
  ...
  \begin{itemize}
  \item numero quote \num{\treStratInvLineeAcquistoNumeroQuote{}};
  \item prezzo medio eseguito di acquisto \Eur{\treStratInvLineeAcquistoPrezzoMedioEffettivo{}};
  \item controvalore dell'operazione \Eur{\treStratInvLineeAcquistoControvaloreOperazione{}};
  \item costo dell'operazione di acquisto \Eur{\treStratInvLineeAcquistoCostoOperazione{}};
  \item controvalore totale \Eur{\treStratInvLineeAcquistoControvaloreTotale};
  \item prezzo medio di carico di acquisto \Eur{\treStratInvLineeAcquistoPrezzoMedioCarico};
  \end{itemize}
\end{enumerate}
...
Si liquidino le \num{125} quote della prima linea di investimento al \emph{prezzo medio effettivo di
   vendita}  di \Eur{46,00},  maggiore del  \emph{prezzo medio  di carico  di acquisto}  delle quote
stesse  \Eur{40,12}, ma  minore  del \emph{prezzo  medio  di carico  nel  saldo} \Eur{48,7823}.   Il
riassunto della contabilità fiscale come calcolato dalla Banca è il seguente:
\begin{itemize}
\item numero quote \num{125};
...
\item rendimento percentuale rispetto al \emph{prezzo medio di carico nel saldo} \SI{-5,9790}{\percent};
\item rendimento in valuta rispetto al \emph{prezzo medio di carico nel saldo} \Eur{-364,59}.
\end{itemize}
...
\emph{prezzo medio effettivo di vendita} di  \Eur{49,50}, minore del \emph{prezzo medio di carico di acquisto}  delle quote
stesse \Eur{50,00},  ma maggiore  del \emph{prezzo medio di carico nel saldo}  \Eur{48,7823}.  Il  riassunto della
...
\item rendimento percentuale rispetto al \emph{prezzo medio di carico nel saldo} \SI{0,7059}{\percent};
\item rendimento in valuta rispetto al \emph{prezzo medio di carico nel saldo} \Eur{34,43}.
\end{itemize}
...
Si liquidino le \num{83} quote della terza  linea di investimento al \emph{prezzo medio effettivo di
   vendita}  di \Eur{65,00},  maggiore del  \emph{prezzo medio  di carico  di acquisto}  delle quote
stesse  \Eur{60,00} e  maggiore  del \emph{prezzo  medio  di carico  nel  saldo} \Eur{48,7823}.   Il
riassunto della contabilità fiscale come calcolato dalla Banca è il seguente:
\begin{itemize}
\item numero quote \num{83};
...
\item rendimento percentuale rispetto al \emph{prezzo medio di carico nel saldo} {\SI{24,1296}{\percent}};
\item rendimento in valuta rispetto al \emph{prezzo medio di carico nel saldo} \Eur{976,99}.
\end{itemize}
Il risultato di  questa operazione dal punto di  vista della terza linea di  investimento può essere
calcolato in due modi:
\begin{enumerate}
\item  con la  quantità  di  soldi uscita  dal  Conto  Corrente per  acquistare  le  quote, cioè  il
  \emph{controvalore totale  di acquisto} \Eur{4994,95},  e la quantità  di soldi entrata  nel Conto
  Corrente dopo la vendita delle quote, cioè il \emph{controvalore totale di vendita} \Eur{5025,92};
\item con il \emph{prezzo  medio di carico di acquisto} \Eur{60,1801} e  il \emph{prezzo medio netto
     di vendita} \Eur{60,5533};
\end{enumerate}
il rendimento della compravendita risulta:
\begin{equation*}
